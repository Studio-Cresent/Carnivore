...
public class Axolotl {
    ...
    public void onLivingDrops(LivingDropsEvent event) {
        ...
        if (!isFireKill) {
            EntityDropUtil.entityDrop(event, "minecraft:axolotl", PMFItemList.RAW_AXOLOTL, 1, 1);
        } else {
            EntityDropUtil.entityDrop(event, "minecraft:axolotl", PMFItemList.COOKED_AXOLOTL, 1, 1);
        }
    }
}
