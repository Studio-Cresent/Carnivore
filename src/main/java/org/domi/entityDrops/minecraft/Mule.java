...
public class Mule {
    ...
    public void onLivingDrops(LivingDropsEvent event) {
        ...
        if (!isFireKill) {
            EntityDropUtil.entityDrop(event, "minecraft:mule", PMFItemList.RAW_HORSE_MEAT, 2, 2);
        } else {
            EntityDropUtil.entityDrop(event, "minecraft:mule", PMFItemList.HORSE_MEAT_STEAK, 2, 2);
        }
    }
}
