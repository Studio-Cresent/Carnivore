...
public class Horse {
    ...
    public void onLivingDrops(LivingDropsEvent event) {
        ...
        if (!isFireKill) {
            EntityDropUtil.entityDrop(event, "minecraft:horse", PMFItemList.RAW_HORSE_MEAT, 2, 2);
        } else {
            EntityDropUtil.entityDrop(event, "minecraft:horse", PMFItemList.HORSE_MEAT_STEAK, 2, 2);
        }
    }
}
