...
public class Orca {
    ...
    public void onLivingDrops(LivingDropsEvent event) {
        ...
        if (!isFireKill) {
            EntityDropUtil.entityDrop(event, "alexsmobs:orca", PMFItemList.RAW_WHALE_MEAT, 3, 2);
        } else {
            EntityDropUtil.entityDrop(event, "alexsmobs:orca", PMFItemList.COOKED_WHALE_MEAT, 3, 2);
        }
    }
}
