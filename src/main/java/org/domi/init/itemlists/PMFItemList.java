...
public class PMFItemList {
    ...
    public static final RegistryObject<Item> RAW_MYCELIUM_BEEF = PMFFoodItem.registerFoodWithEffect("raw_mycelium_beef", 4, 1.2f, new MobEffectInstance(MobEffects.WEAKNESS, 600, 0), 1.0f);
    ...
    public static final RegistryObject<Item> TADPOLE = PMFFoodItem.registerFoodWithEffect("tadpole", 1, 1.0f, new MobEffectInstance(MobEffects.CONFUSION, 600, 0), 1.0f);
    public static final RegistryObject<Item> SQUID_TENTACLE = PMFFoodItem.registerFood("squid_tentacle", 2, 1.0f);
    public static final RegistryObject<Item> GLOW_SQUID_TENTACLE = PMFFoodItem.registerFoodWithEffect("glow_squid_tentacle", 2, 1.0f, new MobEffectInstance(MobEffects.GLOWING, 300, 0), 1.0f);
    public static final RegistryObject<Item> GOLDEN_SQUID_TENTACLE = PMFFoodItem.registerFoodWithMultipleEffects("golden_squid_tentacle", 4, 9.0f,
